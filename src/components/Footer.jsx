...
const Footer = () => {
  const quickLinks = [
    ...
    { name: 'FOCUS AREAS', to: '/focus-areas' }
  ];

  const programs = [
    { name: 'AGRICULTURE', to: '/services/agriculture' },
    { name: 'HEALTH & NUTRITION', to: '/services/nutrition' },
    { name: 'WATER & SANITATION', to: '/services/water' },
    { name: 'YOUTH DEVELOPMENT', to: '/services/youth' },
    { name: 'VOCATIONAL TRAINING', to: '/services/vocational' },
    { name: 'ENVIRONMENTAL', to: '/services/environmental' }
  ];

  const socialLinks = [
    { name: 'Twitter', href: 'https://twitter.com/sudi_ngo', icon: 'M23 3a10.9 10.9 0 01-3.14 1.53 4.48 4.48 0 00-7.86 3v1A10.66 10.66 0 013 4s-4 9 5 13a11.64 11.64 0 01-7 2c9 5 20 0 20-11.5a4.5 4.5 0 00-.08-.83A7.72 7.72 0 0023 3z' },
    { name: 'Facebook', href: 'https://facebook.com/sudi_ngo', icon: 'M18 2h-3a5 5 0 00-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 011-1h3z' },
